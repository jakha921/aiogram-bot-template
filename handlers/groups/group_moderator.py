...
async def read_only_mode(message: types.Message):
    ...
    # Пишем в чат
    await message.answer(f"User {message.reply_to_message.from_user.full_name} {time} deprived of the right to write minute.\n"
                         f"Reason: \n<b>{comment}</b>")

    service_message = await message.reply("The message is turned off in 20 seconds.")
...
async def undo_read_only_mode(message: types.Message):
    ...
    service_message = await message.reply("The message is turned off in 5 seconds.")
